...
public class BossStateMachine : MonoBehaviour
{
    ...
    public GameObject warningPrefab; // 警告预制体
    ...
    void TeleportState()
    {
        ...
        //transform.position = new Vector2(Mathf.Lerp(transform.position.x, targetPosition.x, 1.0f * Time.deltaTime), Mathf.Lerp(transform.position.y, targetPosition.y, 1.0f * Time.deltaTime));
